...
```
cf target -o raghsrin@us.ibm.com -s dev
```
...
You should see an output that lists the different services and the plans that are available via IBM Bluemix.
