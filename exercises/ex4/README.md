...
mysql                    mysql                 100                                                                 create succeeded   
Question and Answer-op   question_and_answer   question_and_answer_free_plan   rags-etherpad-watson-bridge         create succeeded   
rabbitmq                 rabbitmq              100                                                                 create succeeded   
surveydb                 cloudantNoSQLDB       Shared                          bl-todo, bmvirtualV2-ragsibm-1036   create succeeded
```
